        ...
        <div className="p-6 space-y-6">
            ...
            <form>
                <div className="grid grid-cols-3 items-end gap-6">
                    <div className="">
                        <label htmlFor="name" className='text-sm font-medium text-gray-200 block mb-2'>Category Name</label>
                    ...
                    <div className="">
                        <button className='shadow-sm bg-blue-800 border border-gray-700 text-gray-200 sm:text-sm rounded-lg focus:ring-blue-900 focus:border-blue-900 block w-full p-2.5 cursor-pointer' type='submit'> Add Category</button>
                    </div>
                </div>
            </form>
