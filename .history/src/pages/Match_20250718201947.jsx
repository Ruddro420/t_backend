    ...
    return (
        <div className="p-6 space-y-6">
            ...
            <form>
                ...
                {/* Game Details */}
                <h2 className="text-xl font-semibold text-gray-200 mt-6 py-4">Game Details</h2> <hr /><br />
                ...
                {/* Winner Prize */}
                <h2 className="text-xl font-semibold text-gray-200 mt-6 py-4">Winner Prize</h2> <hr /> <br />
