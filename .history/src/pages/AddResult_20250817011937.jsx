...
const AddResult = () => {
    ...
    const VITE_SERVER_API = import.meta.env.VITE_SERVER_API; // Ensure: http://192.168.1.104:8000/api
                        ...
                        return existing
                            ? {
                                ...
                                total_prize: (
                                    ...
                                    parseInt(matchData.kill_price)
                                ) + (parseInt(existing.custom_prize) || 0)
                            }
                            : { ...initialResults.find(r => r.user_id === join.user_id) };
                    });
    ...
    const handleSubmit = async (e) => {
        ...
        const payload = Object.fromEntries(
            Object.entries(rawPayload).filter(([_, v]) => v !== null && v !== "" && v !== undefined)
        );
                    ...
                    <form onSubmit={handleSubmit}>
                        <table className="min-w-full divide-y divide-gray-200">
                            <thead className="bg-gray-800 text-left">
                                <tr>
                                    <th>#</th>
                                    <th>Player 1</th><th>Kill 1</th>
                                    <th>Player 2</th><th>Kill 2</th>
                                    <th>Player 3</th><th>Kill 3</th>
                                    <th>Player 4</th><th>Kill 4</th>
                                    <th>Extra Prize</th><th>Total Prize</th>
                                </tr>
                            </thead>
