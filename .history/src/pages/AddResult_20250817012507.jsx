        ...
        const fetchData = async () => {
            try {
                ...
                if (resultData?.player_results) {
                    ...
                    setWinner(resultData.winner || 0);
                    setSecond(resultData.second || 0);
                    setThird(resultData.third || 0);
                    setFourth(resultData.fourth || 0);
                    setFifth(resultData.fifth || 0);
                    setSixth(resultData.sixth || 0);
                    setIsEditMode(true);
                } else {
